  ...
  return (
    <section id="stack" className="py-16">
      <div className="mx-auto max-w-6xl px-6">
        <Reveal>
          <div className="mb-3 font-mono text-xs text-amber">01 // STACK TECHNIQUE</div>
          <h2 className="font-display text-2xl font-bold text-ink md:text-3xl">Ce avec quoi je travaille</h2>
          <p className="mt-3 max-w-2xl text-ink/70">
            Mon terrain de jeu quotidien : React, TypeScript, Node.js et PostgreSQL. Le reste s'adapte selon ce que le projet demande — j'ai rarement besoin d'en changer.
          </p>
        </Reveal>
